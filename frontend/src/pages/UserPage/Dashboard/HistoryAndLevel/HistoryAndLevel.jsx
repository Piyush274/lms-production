...
const HistoryAndLevel = ({ goal, data }) => {
          ...
          {changeCard === 1 ? (
            <div
              className={`history-right ${
                goal ? "d-flex align-items-center" : ""
              }`}
            >
              <div className="level-img">
                <img src={icons?.levelIcons} alt="right-icons" loading="lazy" />
              </div>
              <div>
                <p className="level-title">Level Up</p>
                <p className="level-pra">
                  Complete tasks to increase your practice pad and account
                  level!
                </p>
            ...
            <div className="history-right">
              <div className="level-img-div">
                <img src={icons?.countIcons} alt="right-icons" loading="lazy" />
                <Button btnText="See more" btnStyle="b-w h-34" />
              </div>{" "}
              <p className="level-title">Complete goals to level up</p>
              <div className="hr-line" />
              <p className="level-song">Learn two songs</p>
              <div className="complete-div">
                <p>Complete 5 skills</p>
                <div className="skill-div">
                  <img src={icons?.dotIcons} alt="true-icons" loading="lazy" />
                  <p>2/5</p>
                </div>
              </div>
