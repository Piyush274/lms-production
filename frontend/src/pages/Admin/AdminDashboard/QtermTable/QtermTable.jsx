  ...
  InitialComment8 : "example@gmail.com",
      ...
      data?.forEach((elem) => {
        ...
        let obj = [
          ...
          {
            value: <div className="ms-20" style={{fontFamily : "GilroyMedium"}}>{Time}</div>,
            className: "wp-30 justify-content-start ",
          },
          {
            value: FName,
    ...
    return (
        <>
              <div className="wp-100 q-temtable">
          <Table
            header={header}
