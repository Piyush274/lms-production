        ...
        <React.Fragment>
          ...
          <div className="page-label">
            ...
            <h2 className="text-la">
              To cancel or change a subscription, please call us during business
              hours at <span>(718) 454-0100</span>
            </h2>
          </div>
                ...
                {benefit?.map((ele, index) => {
                  return (
                    <li className="image-div-s" key={index}>
                      <img src={icons?.tickImg} alt="image" loading="lazy" />
                      <p
...
export default PaymentDetailsTeacher;
