...
import "./PersonalVideoPopup.scss";

const PersonalVideoPopup = ({ onHide, featchSkillEdit, skillId }) => {
  ...
  const uploadFile = async (mediaBlobUrl) => {
    ...
    formData.append("personalTutorials", blob, "recording.mp4");
    const payload = {
      skillId: skillId,
      personalTitle: "screen-shot-1.mp4",
    };
...
export default PersonalVideoPopup;
